...
namespace NobleConnect.Mirror
{
    ...
    public class NobleServer
    {
        ...
        public static void InitializeHosting(int listenPort, GeographicRegion region = GeographicRegion.AUTO, Action<string, ushort> onPrepared = null, Action<Exception> onFatalError = null, bool forceRelayOnly = false)
        {
            _Init(listenPort, RegionURL.URLFromRegion(region), onPrepared, onFatalError, forceRelayOnly);
        }
        ...
        /// <param name="onFatalError">A method to call if something goes horribly wrong.</param>
        public static void InitializeHosting(int listenPort, string relayServerAddress, Action<string, ushort> onPrepared = null, Action<Exception> onFatalError = null, bool forceRelayOnly = false)
        {
        ...
        static void _Init(int listenPort, string relayServerAddress, Action<string, ushort> onPrepared = null, Action<Exception> onFatalError = null, bool forceRelayOnly = false)
        {
        ...
        /// <param name="onPrepared">A method to call when the host has received their HostEndPoint from the relay server.</param>
        static public void Listen(int port = 0, GeographicRegion region = GeographicRegion.AUTO, Action<string, ushort> onPrepared = null, Action<Exception> onFatalError = null, bool forceRelayOnly = false)
        {
